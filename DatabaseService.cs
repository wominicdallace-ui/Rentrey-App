...
namespace RentreyApp.Services
{
    public class DatabaseService
    {
        ...
        private async void SeedProperties()
        {
        ...
        {
            return _database.Table<ApplicationItem>().OrderByDescending(a => a.ApplicationDate).ToListAsync();
        }
        ...
        // Update an existing application (e.g., status changes)
        ...
        {
            return _database.Table<ApplicationItem>()
